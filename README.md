...
<h2 align="center"><strong>< style="font-size: 160%;">Educational project converting a Nondeterministic Finite Automaton into a Deterministic Finite Automaton using C++</strong></h2>
